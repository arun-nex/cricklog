...
import { Match, Innings, Ball, CreateMatchRequest, MatchSummary } from '../models/Match';
...
router.post('/', (req, res) => {
  try {
    const { name, description, team1_id, team2_id, match_type, overs, venue, date }: CreateMatchRequest = req.body;
